...
<script type="text/javascript">
	...
	function loadBaca(page){
		...
		$.post("<?=site_url("ngadimin/pesan?load=baca&page=")?>"+page,{"cari":$("#cari").val()},function(msg){
			$("#load").html(msg);
		});
	}
	function loadSemua(page){
		$("#load").html('<i class="fas fa-spin fa-spinner"></i> Loading data...');
		$.post("<?=site_url("ngadimin/pesan?load=semua&page=")?>"+page,{"cari":$("#cari").val()},function(msg){
			$("#load").html(msg);
		});
	}
