...
<script type="text/javascript">
	$(function(){
		...
		$("#simpan").on("submit",function(e){
			...
			$.post("<?=site_url("ngadimin/tambahvariasi")?>",$(this).serialize(),function(e){
				var data = eval("("+e+")");
				$("#submit").html(btn);
	...
	function hapusSize(id){
		swal.fire({
			...
			if(val.value == true){
				$.post("<?=site_url("ngadimin/hapussize")?>",{"theid":id},function(msg){
					var data = eval("("+msg+")");
					if(data.success == true){
	...
	function hapusWarna(id){
		swal.fire({
			...
			if(val.value == true){
				$.post("<?=site_url("ngadimin/hapuswarna")?>",{"theid":id},function(msg){
					var data = eval("("+msg+")");
					if(data.success == true){
						swal.fire("Berhasil","data telah dihapus","success").then((val)=>{
							window.location.href="<?=site_url("ngadimin/variasi")?>";
