...
<script type="text/javascript">
	function saveManual(val){
		...
		$.post("<?=site_url('api/savesetting')?>",{"payment_transfer":val},function(ev){
			if(val == 1){
	...
	function saveIpaymu(val){
		...
		$.post("<?=site_url('api/savesetting')?>",{"payment_ipaymu":val},function(ev){
			if(val == 1){
	...
	function saveMidtrans(val){
		...
		$.post("<?=site_url('api/savesetting')?>",{"payment_midtrans":val},function(ev){
			if(val == 1){
