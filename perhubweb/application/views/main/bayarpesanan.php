          ...
          <div class="col-12 row">
            ...
            <?php
              ...
              foreach($voc->result() as $v){
                ...
                $potongan = $v->tipe == 2 ? "Rp ".$pot : $pot."%";
                $jenis = $v->jenis == 1 ? "Harga" : "Ongkir";
                echo '
                <tr>
                  <td><i class="fa fa-hashtag" style="font-size:180%;"></i></td>
                  <td><b class="text-danger" >'.$v->kode.'</b></td>
                  <td>'.$v->nama.'<br/><small>'.$v->deskripsi.'</small></td>
                  <td>Potongan '.$jenis.' '.$potongan.'</td>
                  <td>Minimal Pembelian Rp. '.$this->func->formUang( $v->potonganmin).'</td>
                </tr>';
              }
            ?>
            </table>
  		...
  		<div class="col-md-10 m-l-auto m-r-auto m-b-50">
			<div class="bor10 p-l-40 p-r-40 p-t-30 p-b-40 m-r-0 m-l-0">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<h5 style="text-align: right">Rp <span id="totalbayar" style="padding-left:40px"><?php echo $this->func->formUang($totalbayar); ?></h5>
					</div>
				</div>
			</div>
        </div>
