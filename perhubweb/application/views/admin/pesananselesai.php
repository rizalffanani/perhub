				...
				<div class="row">
					<div class="col-md-3">
						<?php
							...
							if($ul->num_rows() > 0){
						?>
							<a href="<?php echo site_url("manage/ulasan/".$rx->orderid); ?>" class="flex-c-m stext-101 cl0 size-107 bg1 hov-btn1 p-lr-15 trans-04 m-b-10">
								LIHAT ULASAN
							</a>
						<?php
							}else{
					...
					<div class="col-md-5">
						...
						<i class="color1"><?php echo $this->func->ubahTgl("d M Y H:i",$rx->selesai); ?> WIB</i>
					</div>
					<div class="col-md-4">
						<div class="row">
