			...
			<div class="row">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-50">
					<div class="leftbar p-r-20 p-r-0-sm">
						...
						<ul class="p-b-54">
							<li class="p-t-4">
								<a href="#" class="s-text13 active1 font-weight-bold color1">
									Semua Produk
								</a>
							</li>
							...
							?>
							<li class="p-t-4">
								<a href="<?=site_url("kategori/".$r->url)?>" class="s-text13">
						...
						<div class="search-product pos-relative bo4 of-hidden">
							<form action="" method="GET">
								<input class="s-text7 size6 p-l-23 p-r-50" type="text" value="<?=$cari?>" name="cari" placeholder="Cari Produk">
